...
(JSON Schema 2020-12), fixtures `fixtures/engine-response/engine-response-v1-*.jsonl`.
...
> as [`engine-response.v2`](engine-response-v2.md); the QW-018 design record
> that used to live here moved there. v2 does not replace v1: a v1 body is
> still a valid v1 body.
